...
function setShuffle() {
	...
	if(shuffle == true) {
		...
		//shuffe has been deactivated
		// go back to reguar payist
		//check for errors in currentypaying
		currentIndex = currentPlaylist.indexOf(audioElement.currentPlaylist.id);
